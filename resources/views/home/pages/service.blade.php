                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>16</td>
                            <td><img src="{{ asset('images/silai.jpg') }}" alt="Service Image" class="img-fluid"
                                    style="max-width: 130px;"></td>
                            <td>Sewing</td>
                            <td>Skill Development</td>
                            <td class="text-wrap">Empowering individuals through hands-on skill training for
                                self-sufficiency.</td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>1</td>
                            <td><img src="{{ asset('images/education.jpg') }}" alt="Service Image" class="img-fluid"
                                    style="max-width: 130px;"></td>
                        ...
                        <tr>
                            <td>3</td>
                            <td>16</td>
                            <td><img src="{{ asset('images/parlour.jpg') }}" alt="Service Image" class="img-fluid"
                                    style="max-width: 130px;"></td>
                        ...
                        <tr>
                            <td>4</td>
                            <td>3</td>
                            <td><img src="{{ asset('images/food.jpg') }}" alt="Service Image" class="img-fluid"
                                    style="max-width: 130px;"></td>
                            <td>Free Food</td>
                        ...
                        <tr>
                            <td>5</td>
                            <td>13</td>
                            <td><img src="{{ asset('images/woman.jpg') }}" alt="Service Image" class="img-fluid"
                                    style="max-width: 130px;"></td>
