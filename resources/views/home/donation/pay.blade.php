    ...
    <div class="container-fluid">
        <div class="row m-3">
            <div class="col-md-12 text-center">
                <h4 class="text-success">Welcome To Donation Box</h4>
            </div>
        </div>
        <div class="card m-2 shadow-lg p-4">
            <div class="card-header">
                <div class="card-title">
                    <h4>Fill the fields for donation <span class="fw-bold" style="font-size: 18px;">( After Donation Get A Certificate )</span></h4>
                </div>
            </div>
            <div class="card-body">
                <form method="post" action="payment.php">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="donor_number" id="" maxlength="10">
                        </div>
                    </div>
                    <!-- Toggle Option -->
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="provideAddress" class="form-label">Do you want to provide address (Optional)</label>
                    ...
                    <div id="addressSection" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="stateSelect" name="donor_state" onchange="updateDistricts(this.value)">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" name="donor_district" id="districtSelect" disabled>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="confirmIdType" class="form-label">Do you want to provide ID Type? (Optional)</label>
                    ...
                    <div class="row" id="aadharInput" style="display: none;">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="donor_aadhar" class="form-control" id="aadhar" placeholder="Enter Aadhar Number" maxlength="12" oninput="validateAadhar()">
                            <small id="aadharError" style="color: red; display: none;">Aadhar number must be 12 digits.</small>
                        </div>
                    </div>
                    <div class="row" id="panInput" style="display: none;">
                        <div class="col-md-6 mb-3">
                            <label for="pan" class="form-label">PAN Card Number</label>
                            <input type="text" class="form-control" name="donor_pancard" id="pan" placeholder="Enter PAN Number" maxlength="10" oninput="validatePAN()">
                            <small id="panError" style="color: red; display: none;">PAN number must be in format: ABCDE1234F.</small>
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            <label for="selectCategory" class="form-label">Do you want to select a category (Optional)
                                <!-- <span style="font-size: 12px;">(Not Mandatory, you can skip and donate )</span> -->
                            </label>
                            <select class="form-select form-control" id="selectCategory" onchange="toggleCategorySelection()">
                                <option value="">-- Select --</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
                    ...
                    <div class=" row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="donation_amount" id="amount" value="<?php echo htmlspecialchars($donationAmount); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6 row">
                        <div class="text-center">
                            <!-- <input type="submit" class="btn btn-success mt-1" value="Pay Now" name="submit"> -->
                            <button type="submit" name="submit" class="btn btn-success mt-2">Pay Now</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    function updateDistricts() {
        ...
        const stateDistricts = {
            ...
            "Uttar Pradesh": [
                "Agra", "Aligarh", "Allahabad", "Ambedkar Nagar", "Auraiya", "Azamgarh", "Bagpat", "Bahraich", "Ballia", "Balrampur",
                "Banda", "Barabanki", "Bareilly", "Basti", "Bijnor", "Budaun", "Bulandshahr", "Chandauli", "Chitrakoot", "Deoria",
                "Etah", "Etawah", "Faizabad", "Farrukhabad", "Fatehpur", "Firozabad", "Gautam Buddha Nagar", "Ghaziabad", "Ghazipur",
                "Gonda", "Gorakhpur", "Hamirpur", "Hardoi", "Hathras", "Jalaun", "Jaunpur", "Jhansi", "Jyotiba Phule Nagar", "Kannauj",
                "Kanpur Dehat", "Kanpur Nagar", "Kaushambi", "Kheri", "Kushinagar", "Lalitpur", "Lucknow", "Mahoba", "Maharajganj",
                "Mainpuri", "Mathura", "Mau", "Meerut", "Mirzapur", "Moradabad", "Muzaffarnagar", "Pilibhit", "Pratapgarh", "RaeBareli",
                "Rampur", "Saharanpur", "Sant Kabir Nagar", "Sant Ravidas Nagar", "Shahjahanpur", "Shravasti", "Siddharthnagar",
                "Sitapur", "Sonbhadra", "Sultanpur", "Unnao", "Varanasi", "Manyavar Kanshiram Nagar", "Prabuddha Nagar",
            ...
            "Delhi": ["Central Delhi", "North Delhi", "South Delhi", "East Delhi", "North East Delhi",
                "South West Delhi", "New Delhi", "North West Delhi", "West Delhi", "Shahdara", "South East Delhi"
            ],
...
<script>
    ...
    $(document).ready(function() {
        <?php if ($status === 'success'): ?>
            showToast('success', 'Thanks for the Donation!');
