            ...
            <div class="card m-2 shadow-lg p-4">
                <div class="card-header">
                    <div class="card-title">
                        <h4>Fill the fields for donation <span class="fw-bold" style="font-size: 18px;">( After Donation Get A
                                Certificate )</span></h4>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="">
                        ...
                        <div id="addressSection" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control select2" id="countrySelect" name="donor_country">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control select2" id="stateSelect" name="donor_state"
                        ...
                        <div class="row" id="idTypeSelection" style="display: none;">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" name="donor_idtype" id="idType" onchange="showIdInput()">
                                    <option value="">Select</option>
                        ...
                        <div class="row" id="aadharInput" style="display: none;">
                            <div class="col-md-6 mb-3">
                                ...
                                <small id="aadharError" style="color: red; display: none;">Aadhar number must be 12
                                    digits.</small>
                            </div>
                        </div>
                        <div class="row" id="panInput" style="display: none;">
                            <div class="col-md-6 mb-3">
                                ...
                                <small id="panError" style="color: red; display: none;">PAN number must be in format:
                                    ABCDE1234F.</small>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class=" row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" name="donation_amount" id="amount"
                                    value="<?php echo htmlspecialchars($donationAmount); ?>" required>
                            </div>
                        </div>
