    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
            <div class="card mb-4 shadow-sm">
                <div class="row g-0">
                    <div class="col-md-5">
                        <img src="images/clothe.jpg" class="img-fluid rounded-start w-100 h-100" alt="Clothes Donation">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
                            <h5 class="card-title">Clothe the Needy</h5>
                            <h6 class="card-subtitle text-muted mb-2">Warmth is a Gift</h6>
                            <p class="card-text">Donate to provide clean and warm clothes to children, elderly, and families living on the streets.</p>
