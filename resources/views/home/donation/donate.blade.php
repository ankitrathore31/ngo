                   ...
                   <form method="post" action="payment.php">
                       ...
                       <div class=" row">
                           <div class="col-md-6 mb-3">
                               ...
                               <input type="number" class="form-control" name="donation_amount" id="amount" value="" required>
                           </div>
                       </div>
               ...
               <div class="row justify-content-center">
                  <div class="col-md-12">
                     ...
                     <a href="upi://pay?pa=gyanbhartingo@ybl&pn=GYAN%20BHARTI%20SANSTHA" target="_blank">
                        <img src="images/qr.jpeg" class="img-fluid mb-3" alt="QR Code" style="max-width: 200px;">
                     </a>
                  </div>
               </div>
               <div class="row">
                  <div class="col-md-6 text-center">
                     <!-- Download Button -->
                     <a href="images/qr.jpeg" download="GyanBharti_UPI_QR" class="btn btn-outline-primary btn-sm">
