    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
            <div class="card mb-4 shadow-sm">
                <div class="row g-0">
                    <div class="col-md-5">
                        <img src="images/enviroment.jpeg" class="img-fluid rounded-start w-100 h-100" alt="Environment">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
                            <h5 class="card-title">Protect Our Planet</h5>
                            <h6 class="card-subtitle text-muted mb-2">Plant Trees. Save Future.</h6>
                            <p class="card-text">Your donation will fund tree planting, clean-up drives, and awareness programs to fight climate change.</p>
