        ...
        <div class="d-flex justify-content-between align-record-centre mb-2 mt-3">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light px-3 py-2 mb-0 rounded">
                    <li class="breadcrumb-record"><a href="{{ url('welcome') }}">Dashboard</a></li>
            ...
            <div class="card">
                <div class="card-body shadow rounded p-4 my-4 print-card">
                    ...
                    <p style="font-size: 1.2rem; line-height: 1.8;" data-lang="en">
                        ...
                        S/O or W/O <strong>{{ $donor->gurdian_name ?? 'Donation with OnlineCashfree' }}</strong>, resident
                        of
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div>
                            ...
                            {{ ucfirst($donor->payment_method) ?? 'Donation with OnlineCashfree' }}
                        </div>
