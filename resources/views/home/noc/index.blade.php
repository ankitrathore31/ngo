        ...
        <div class="container-fluid mt-4">
                ...
                <div class="col-md-3 col-6">
                    <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #198754 !important;">
                        <div class="card-body d-flex align-items-center gap-3 py-3">
                            ...
                            <div>
                                <div class="fw-bold fs-4 lh-1">{{ \App\Models\Noc::where('file_type', 'image')->count() }}
                                </div>
                ...
                <div class="col-md-3 col-6">
                    <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #dc3545 !important;">
                        <div class="card-body d-flex align-items-center gap-3 py-3">
                            ...
                            <div>
                                <div class="fw-bold fs-4 lh-1">{{ \App\Models\Noc::where('file_type', 'pdf')->count() }}
                                </div>
                ...
                <div class="col-md-3 col-6">
                    <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #fd7e14 !important;">
                        <div class="card-body d-flex align-items-center gap-3 py-3">
                            ...
                            <div>
                                <div class="fw-bold fs-4 lh-1">{{ \App\Models\Noc::where('file_type', 'other')->count() }}
                                </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
                    ...
                    {{-- <small class="text-muted">Showing  of
                        {{ $nocs->total() }}</small> --}}
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0" id="nocTable">
                            <thead class="table-light">
                                <tr>
                                    <th class="ps-4" style="width:55px;">Sr. No.</th>
                                    <th>NOC Date</th>
                                    <th>NOC Area</th>
                            ...
                            <tbody>
                                @forelse($nocs as $index => $noc)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge  bg-opacity-10 text-primary fw-normal px-2 py-1">
                                        ...
                                        <td>
                                            @if ($noc->file_type === 'image')
                                                <span class="badge bg-opacity-10 text-success">
                                                    <i class="fas fa-image me-1"></i>Image
                                                </span>
                                            @elseif($noc->file_type === 'pdf')
                                                <span class="badge bg-opacity-10 text-danger">
                                                    <i class="fas fa-file-pdf me-1"></i>PDF
                                                </span>
                                            @else
                                                <span class="badge bg-opacity-10 text-warning">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-1">
                                                {{-- View --}}
                                                <a href="{{ route('home.noc.show', $noc->id) }}"
