        ...
        <div class="row g-3 d-flex justify-content-around">
            <div class="col-md-4 col-sm-6 col-12 mb-3">
                <div class="certificate-card">
                    ...
                    <img src="assets/images/certtt.jpeg" class="img-fluid" alt="Certificate 1">
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-12 mb-3">
                <div class="certificate-card">
                    <h5 class="certificate-title">ISO Sanstha Certificate</h5>
                    <img src="assets/images/cert7.jpg" class="img-fluid" alt="Certificate 7">
                </div>
            </div>
        </div>
        ...
        <div class="row g-3 d-flex justify-content-around">
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-3">
                <div class="certificate-card">
                    ...
                    <img src="assets/images/cert2.jpeg" class="img-fluid" alt="Certificate 2">
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-12 mb-3">
                <div class="certificate-card">
                    <h5 class="certificate-title">Sanstha Pan Card</h5>
                    <img src="assets/images/cert3.jpg" class="img-fluid" alt="Certificate 3">
                </div>
            </div>
        ...
        <div class="row  g-3 d-flex justify-content-between">
            ...
            <div class="col-lg-6 col-md-6 mb-3">
                <div class="certificate-card">
                    ...
                    <img src="assets/images/cert6a.jpg" class="img-fluid" alt="Certificate 6A">
                    <img src="assets/images/cert6b.jpg" class="img-fluid" alt="Certificate 6B">
                    <!-- </div> -->
                </div>
            </div>
            <!-- Certificate 80G -->
            <div class="col-lg-6 col-md-6 mb-3">
                <div class="certificate-card">
                    ...
                    <!-- <div class="certificate-images"> -->
                    <img src="assets/images/cert8a.jpg" class="img-fluid" alt="Certificate 8A">
                    <img src="assets/images/cert8b.jpg" class="img-fluid" alt="Certificate 8B">
                    <!-- </div> -->
                </div>
            </div>
        ...
        <div class="row g-3 d-flex justify-content-around">
            ...
            <div class="col-md-6 col-sm-6 col-12 mb-3">
                <div class="certificate-card">
                    ...
                    <img src="assets/images/cert4.jpg" class="img-fluid" alt="Certificate 4">
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-12 mb-3">
                <div class="certificate-card">
                    <h5 class="certificate-title">Sanstha Information Certificate</h5>
                    <img src="assets/images/cert5.jpg" class="img-fluid" alt="Certificate 5">
                </div>
            </div>
        </div>
        ...
        <div class="row g-3 d-flex justify-content-around">
            ...
            <div class="col-md-6 col-sm-6 col-12 mb-3">
                <div class="certificate-card">
                    ...
                    <img src="assets/images/check.jpeg" class="img-fluid" alt="Certificate 2">
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-12 mb-3">
                <div class="certificate-card">
                    <h5 class="certificate-title">Sanstha PAyment Qr</h5>
                    <img src="assets/images/qr.jpeg" class="img-fluid" alt="Certificate 3">
                </div>
            </div>
