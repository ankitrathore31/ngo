    ...
    <div class="wrapper">
        <div class="container-fluid mt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Verify Health Facility List</h5>
            ...
            @endif
            <div class="row">
                <form method="GET" action="{{ route('list.Verifyhealthfacility') }}" class="row g-3 mb-4">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('list.Verifyhealthfacility') }}"
                        ...
                        <tbody>
                            @foreach ($combined as $index => $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('healthfacility.investigation.form.show', $facility->id) }}"
                                            class="btn btn-warning btn-sm me-2 mb-1" title="Edit">
                                            Verify Facilities Bill
                                        </a>

                                        <a href="{{-- route('delete.Investigationfacilityform', $facility->id) --}}"
