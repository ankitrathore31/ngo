...
@section('content')
    ...
    <div class="wrapper">
        <div class="d-flex justify-content-between align-person-centre mb-0 mt-4">
            <h5 class="mb-0">Verified Health Facilities Bill</h5>
        ...
        <div class="container-fluid mt-5">
            ...
            <div class="d-flex justify-content-between align-persons-center mb-3 mt-4">
                <h5 class="mb-0">
                    <span>Verified Health Facilities Bill</span>
                </h5>
                <div>
                    ...
                    <div>
                        <div class="p-2" style="border: 9px solid #138808;">
                            <div class="text-center mb-4 border-bottom pb-2">
                                <div class="row mb-2">
                                    <div class="col-sm-12">
                                        <h3><b>Verified Health Facilities Bill</b></h3>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <form action="{{ route('status.healthfacility.store', $facility->id) }}"
                                        method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-sm-4 mb-3">
                                                <strong>Total Bill Amount:</strong> <br>
                                                <span id="billAmountText">
                                                    <b>{{ number_format($facility->bill_amount ?? 0, 2) }}</b>
                                                </span>

                                                <input type="hidden" id="bill_amount"
                                                    value="{{ $facility->bill_amount ?? 0 }}">
                                            </div>
                                            ...
                                            <div class="col-sm-4 mb-3">
                                                ...
                                                <input type="number" id="percentage" class="form-control"
                                                    ...
                                                    placeholder="Enter percentage" oninput="calculateClearingAmount()">
                                            </div>

                                            <div class="col-sm-4 mb-3">
                                                <label><strong>Clearness Amount</strong></label>
                                                <input type="text" id="clearing_amount" name="clearness_amount" class="form-control" readonly>
                                            </div>
                                            ...
                                            <div class="col-sm-6 mb-3 no-print" id="reason_field" style="display:none;">
                                                <b>Reason</b>
                                            ...
                                            <div class="col-sm-3 mb-3 text-start no-print">
                                                <a href="{{-- route('reject.healthfacility.investigation', $facility->id) --}}" class="btn mt-4 btn-danger">
                                                    Reject Verificaton
                                                </a>
                                            </div>
