    ...
    <div class="wrapper">
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Pending Health Facility List</h5>
            ...
            @endif
            <div class="row">
                <form method="GET" action="{{ route('list.pendingfacility') }}" class="row g-3 mb-4">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('list.pendingfacility') }}" class="btn btn-info text-white me-1">Reset</a>
                        </div>
                    </div>
                </form>
            </div>
                            ...
                            @foreach ($combined as $index => $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('delete.healthfacility', $facility->id) }}"
                                            onclick="return confirm('Are sure want to delete Health Facility')"
