    ...
    <div class="wrapper">
        <div class="container-fluid mt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Reject Education Facility List</h5>
            ...
            @endif
            <div class="row">
                <form method="GET" action="{{ route('education.list.Rejectfacility') }}" class="row g-3 mb-4">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('education.list.Rejectfacility') }}"
