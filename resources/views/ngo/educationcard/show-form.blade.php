                    ...
                    <div>
                        <div class="p-2">
                            ...
                            <div class="row d-flex mt-2 justify-content-between">
                                <div class="col-sm-6 mb-3">
                                    {{-- @php
                                        $investigationStaff = staffByEmail($facility->verify_officer);
                                    @endphp
                            ...
                            <div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="approveModalLabel"
                                ...
                                <div class="modal-dialog">
                                    <form method="POST" action="{{-- route('investigation.education.facility.approve', $facility->id) --}}" enctype="multipart/form-data">
                                        @csrf
                            ...
                            <div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="rejectModalLabel"
                                aria-hidden="true">
                                <div class="modal-dialog">
                                    <form method="POST" action="{{-- route('investigation.education.facility.reject', $facility->id) --}}">
                                        @csrf
