...
@Section('content')
    ...
    <div class="wrapper">
        <div class="container-fluid mt-4">
            ...
            @endif
            <div class="row">
                <form method="GET" action="{{ route('education.list.Approvalfacility') }}" class="row g-3 mb-4">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('education.list.Approvalfacility') }}"
                                ...
                                @foreach ($combined as $index => $row)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-start">
                                            ...
                                            @else
                                                <span class="badge bg-warning text-dark">Investigation Verified</span>
                                            @endif
                                        </td>
