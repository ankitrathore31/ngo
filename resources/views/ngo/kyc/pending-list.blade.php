    ...
    <div class="wrapper">
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Pending Kyc List</h5>
            ...
            @endif
            <div class="row">
                <form method="GET" action="{{ route('list.pending.kyc') }}" class="row g-3 mb-4">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('list.pending.kyc') }}" class="btn btn-info text-white me-1">Reset</a>
                        </div>
                    </div>
                </form>
            </div>
                            ...
                            @foreach ($beneficiarie as $index => $item)
                                <tr>
                                    ...
                                    <td class=" gap-1">
                                        ...
                                        <a href="{{ route('edit-beneficiare-kyc', [
                                            'id' => $item->id,
                                            'kyc_id' => $item->kyc->first()->id,
                                        ]) }}"
                                            class="btn mb-1 btn-sm btn-warning">
                                            Edit
                                        </a>
