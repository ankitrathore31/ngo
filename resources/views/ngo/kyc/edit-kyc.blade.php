    ...
    <div class="wrapper">
        <div class="container-fluid mt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Edit Kyc Form</h5>
            ...
            <div class="container my-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="fw-bold">Edit Kyc Form</h2>
                ...
                <div class="card p-4 shadow rounded mt-2">
                    <form action="{{ route('kyc.update', $kyc->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div id="frontPreview" class="mt-2">
                        ...
                        <select name="staff" class="form-select" required>
                            @foreach ($staffs as $person)
                                ...
                                @endphp
                                <option value="{{ $value }}" {{ $kyc->verified_by == $value ? 'selected' : '' }}>
                                    {{ $person->name }} ({{ $person->staff_code }}) ({{ $person->position }})
                                </option>
                            @endforeach
                        </select>
                        ...
                        <input type="date" name="verified_at" class="form-control"
                            value="{{ \Carbon\Carbon::parse($kyc->verified_at)->format('Y-m-d') }}" required>

                        <button class="btn btn-primary mt-4">Update KYC</button>
                    </form>
                </div>
