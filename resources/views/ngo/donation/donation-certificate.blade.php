                        ...
                        <div style ="border: 8px solid #138808; padding: 4px;"> <!-- Inner Saffron -->
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <p style="margin: 0;"><b>
                                            <span data-lang="hi">पंजीकरण सं.: 80G-AAEAG7650BF20231 | 12A: AAEAG7650BE20231 |
                                                दिनांक:
                                                02-10-2023</span>
                                            <span data-lang="en">Reg. No: 80G-AAEAG7650BF20231 | 12A: AAEAG7650BE20231 |
                                                Date:
                                                02-10-2023</span>
                            ...
                            <div class="row d-flex justify-content-between mt-2">
                                ...
                                <div class="col-sm-4 text-end">
                                    <strong>Donation Date:</strong> {{ \Carbon\Carbon::parse($donor->date)->format('d-m-Y') }}
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                ...
                                <p style="font-size: 1.2rem; line-height: 1.8;" data-lang="en">
                                    ...
                                    <strong>{{ $donor->gurdian_name ?? 'Donation with OnlineCashfree' }}</strong>,
                                    resident of
                                    <strong>{{ $donor->address }}</strong>. The Sanstha will utilize this amount for the
                                    welfare
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-4">
                                    <div>
                                        ...
                                        <span  class="text-success">{{ ucfirst($donor->payment_method) ?? 'Donation with OnlineCashfree' }}</span>
                                    </div>
