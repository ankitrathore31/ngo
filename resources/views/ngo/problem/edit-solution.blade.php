...
@Section('content')
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="mb-0">Edit Social Problem Solution</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="date" id=""
                                ...
                                placeholder="Select Date" value="{{$problem->solution_date}}" required>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('solution_description') is-invalid @enderror" name="solution_description"
                                    rows="3" placeholder="Solution Description" required>{{ old('solution_description',$problem->solution_description) }}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="form-control @error('solution_by') is-invalid @enderror" name="solution_by"
                                    ...
                                    @foreach ($staff as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('solution_by', $problem->solution_by ?? '') == $item->id ? 'selected' : '' }}>
