                ...
                <form action="{{-- route('store.problem') --}}" method="POST" enctype="multipart/form-data" class="m-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" id="" class=" form-control @error('date') is-invalid @enderror"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="" class="form-label">Problem Address <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" rows="3"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="3"
                                    placeholder="Problem Description" required></textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                            <label for="problem_by" class="form-label ">Problem Discover By <span
                                    class="text-danger">*</span></label>
                            <select class="form-control @error('problem_by') is-invalid @enderror"
                                name="problem_by" required>
