    ...
    <div class="wrapper">
        <div class="container-fluid mt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Experience Certificate List</h5>
            ...
            <div class="row">
                <form method="GET" action="{{ route('experience-list') }}" class="row g-3 mb-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('experience-list') }}" class="btn btn-info text-white me-1">Reset</a>
                    </div>
                </form>
                        ...
                        <tbody>
                            @foreach ($records as $item)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($item->fromDate)->format('d-m-Y')}} To 
                                    </td> 
                                    <td>{{ \Carbon\Carbon::parse($item->toDate)->format('d-m-Y')}}</td>
                                    {{-- <td>{{$item->duration}}</td> --}}
                                    <td>{{ $item->beneficiare->academic_session ?? 'N/A' }}</td>
                                    <td>
                                        <div class="d-flex justify-content-center gap-2 flex-wrap">
                                            <a href="{{ route('experience-certificate', $item->id) }}" class="btn btn-success btn-sm px-3"
                                            >
                                            Experience
                                            </a>
                                        </div>
