    ...
    <div class="wrapper">
        <div class="container-fluid mt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Member Activity List</h5>

                <!-- Breadcrumb aligned to right -->
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-light px-3 py-2 mb-0 rounded">
                        <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Member Activity List</li>
                    </ol>
                </nav>
            </div>
            @if (session('success'))
            ...
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <a href="{{ route('add-memberactivity') }}" class="btn btn-success btn-sm">+ Add Activity</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2 flex-wrap">
                                            <a href="{{-- route('viewmemberactivity', $item->id) --}}" class="btn btn-sm btn-success" title="View">
                                    ...
                                    <td>
                                        <a href="{{ route('member-activity-certi',['id' => $item->id, 'category' => $item->program_category]) }}"
