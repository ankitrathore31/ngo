                                ...
                                <tr class="animate__animated animate__fadeInUp">
                                    ...
                                    <td>
                                        @if ($job->status == 'active')
                                            <span class="badge text-white p-2 bg-success">Active</span>
                                        @else
                                            <span class="badge text-white p-2 bg-danger">Closed</span>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('edit.job', $job->id) }}" class="btn btn-sm btn-warning">
                                            <i class="fa fa-pencil-square"></i>
                                        </a>
                                        <a href="{{ route('delete.job', $job->id) }}" class="btn btn-sm btn-danger"
