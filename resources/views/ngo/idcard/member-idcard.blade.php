    ...
    <div class="wrapper">
        <div class="container-fluid mt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-1">
                <h5 class="mb-0">Member Id Card List</h5>
            ...
            @endif
            <div class="row">
                <form method="GET" action="{{ route('member-idcard') }}" class="row g-3 mb-4">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('member-idcard') }}" class="btn btn-info text-white me-1">Reset</a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="container d-flex flex-wrap justify-content-center">
                @foreach ($member as $record)
                    <div class="id-card">
                        ...
                        <div class="id-body">
                            <div class="left">
                                <img src="{{ asset('member_images/' . $record->image) }}" class="photo-img" alt="Photo">
                            </div>
                            <div class="right">
