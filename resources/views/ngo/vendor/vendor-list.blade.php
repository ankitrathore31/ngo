...
@Section('content')
    ...
    <div class="wrapper">
        <div class="container-fluid mt-4">
            ...
            <div class="row">
                <form method="GET" action="{{ route('vendor.list') }}" class="row g-3 mb-4">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <a href="{{ route('add.vendor') }}" class="btn btn-success">+ Add Vendor</a>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2 flex-wrap">
                                            ...
                                            <a href="{{ route('delete.vendor', $item->id) }}"
