        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light px-3 py-2 mb-0 rounded">
                    <li class="breadcrumb-item"><a href="{{ route('activitylist') }}">Event List</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="program_date"
                                class="form-control @error('program_date') is-invalid @enderror" required>
                            @error('program_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="event_report" class="form-control @error('event_report') is-invalid @enderror" rows="3"
                                placeholder="Enter Report" required></textarea>
                            @error('event_report')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
