...
@Section('content')
    <div class="wrapper">
        <div class="container-fluid mt-4">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="GET" action="{{ route('event-list') }}" class="row g-3 mb-4">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4 d-flex">
                            ...
                            <a href="{{ route('event-list') }}" class="btn btn-info text-white me-2">Reset</a>
                        </div>
                    </form>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2 flex-wrap">
                                            <a href="{{ route('view-event', $item->id) }}" class="btn btn-sm btn-success" title="View">
                                                <i class="fa-regular fa-eye"></i>
                                            </a>
                                            <a href="{{ route('edit-event', $item->id) }}" class="btn btn-sm btn-primary" title="Edit">
                                                <i class="fa-regular fa-pen-to-square"></i>
                                            </a>
                                            <a href="{{ route('remove-event', $item->id) }}" onclick=" return confirm('Do you want delete event')" class="btn btn-sm btn-danger" title="Delete">
