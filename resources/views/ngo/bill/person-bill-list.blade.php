...
@Section('content')
    <div class="wrapper">
        <div class="container-fluid mt-4">
            ...
            <div class="row">
                <form method="GET" action="{{ route('person-bill-list') }}" class="row g-3 mb-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('person-bill-list') }}" class="btn btn-info text-white me-1">Reset</a>
                    </div>
                </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2 flex-wrap">
                                            <a href="{{ route('view-person-bill', $item->id) }}"
                                                class="btn btn-success btn-sm px-3">
                                                <i class="fa-regular fa-eye"></i>
                                            </a>
                                            <a href="{{ route('edit-person-bill', $item->id) }}" class="btn btn-primary btn-sm"
                                                title="Edit">
                                                <i class="fa-regular fa-edit"></i>
                                            </a>
                                            <a href="{{ route('delete-person-bill', $item->id) }}" class="btn btn-danger btn-sm "
