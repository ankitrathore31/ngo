            ...
            <div class="card mt-4 p-3 border border-success rounded">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <label for="survey_details" class="form-label fw-bold">
                            Survey Details <span class="text-danger"></span>
                        </label>
                        <div class="bg-light border rounded p-3">
                            {{ $beneficiarie->survey_details }}
                        </div>
                    </div>

                    <!-- Help by NGO -->
                    <div class="col-md-6 mb-4">
                        <label for="help_by_ngo" class="form-label fw-bold">
                            Facilities (Help By Ngo): <span class="text-danger"></span>
                        </label>
                        <div class="bg-light border rounded p-3">
                            {{ $beneficiarie->help_by_ngo }}
                        </div>
                    </div>

                    <!-- Survey Date -->
                    <div class="col-md-6 mb-4">
                        <label for="survey_date" class="form-label fw-bold">
                            Survey Date <span class="text-danger"></span>
                        </label>
                        <div class="bg-light border rounded p-3">
                            {{ \Carbon\Carbon::parse($beneficiarie->survey_date)->format('d M Y') }}
                        </div>
                    </div>
