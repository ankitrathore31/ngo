...
@section('content')
    ...
    <style>
        @media print {
            ...
            /* Hide placeholder text but keep fields visible as blank */
            .print-card input::placeholder,
            .print-card textarea::placeholder {
                color: transparent !important;
            }

            .print-card input::-webkit-input-placeholder,
            .print-card textarea::-webkit-input-placeholder {
                color: transparent !important;
            }

            .print-card input::-moz-placeholder,
            .print-card textarea::-moz-placeholder {
                color: transparent !important;
            }

            .print-card input[type="date"]::-webkit-datetime-edit {
                color: transparent !important;
            }

            /* Hide select default/placeholder option text, show blank */
            .print-card select {
                color: transparent !important;
            }

            .print-card select option {
                display: none !important;
            }

            /* Keep selected value visible if something is selected */
            .print-card select.has-value {
                color: #000 !important;
            }
                    ...
                    <div class="print-card">
                            ...
                            <div class="text-center mb-4 border-bottom">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-10 text-center">
                                        <h4 style="color: red; font-weight:500; font-size:25px;"><b>GYAN BHARTI SANSTHA</b>
                                        </h4>
                        ...
                        <div class="card mt-4 p-3 border border-success rounded">
                            <form action="{{ route('store-beneficiarie', $beneficiarie->id) }}" method="POST">
                                        ...
                                        <div id="survey_section" style="display: none;">
                                            @foreach ($facilities as $index => $facility)
                                                <div class="mb-4 p-2 rounded">
                                                    <label><strong>{{ $index + 1 }}.
                                                            {{ $facility }}:</strong></label>
                                                    <div class="form-check form-check-inline ml-3">
                                                        <input class="form-check-input" type="radio"
                                                            name="surveyfacility_status[{{ $facility }}]"
                                                            value="Yes" id="{{ Str::slug($facility) }}_yes">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="surveyfacility_status[{{ $facility }}]"
                                                            value="No" id="{{ Str::slug($facility) }}_no">
                                                        <label class="form-check-label"
                                ...
                                <div class="row mt-4">
                                    <div class="no-print col-md-4 col-sm-6">
    ...
    <script>
        // Mark selects that have a real value selected (not placeholder)
        document.querySelectorAll('select').forEach(function(sel) {
            ...
            sel.addEventListener('change', checkValue);
            checkValue();
        });
    </script>
@endsection
