                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 form-group mb-3">
                                            ...
                                            <input type="text" name="application_date" id="application_date"
                                                ...
                                                value="{{ $beneficiarie->application_date }}" readonly required>
                                        ...
                                        <div class="col-md-6 col-sm-6  form-group mb-3">
                                            ...
                                            <input type="text" name="name" id="name"
                                                ...
                                                value="{{ $beneficiarie->name }}"readonly required>
                                            @error('name')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 col-sm-6 form-group mb-3">
                                            ...
                                            <input type="text" name="dob" id="dob"
                                                class="form-control datepicker @error('dob') is-invalid @enderror"
                                                value="{{ $beneficiarie->dob }}" readonly required>
                                            @error('dob')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" name="mother_name" id="mother_name"
                                            ...
                                            value="{{ $beneficiarie->mother_name }}" readonly required>
                                        @error('mother_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <input type="text" name="village" id="village"
                                        ...
                                        value="{{ $beneficiarie->village }}" readonly>
                                    @error('village')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <input type="text" name="post" id="post"
                                        ...
                                        value="{{ $beneficiarie->post }}"readonly required>
                                    @error('post')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <input type="text" name="block" id="block"
                                        ...
                                        value="{{ $beneficiarie->block }}"readonly required>
                                    @error('block')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <input type="number" name="pincode" id="pincode"
                                        ...
                                        value="{{ $beneficiarie->pincode }} " readonly>
                                    @error('pincode')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-sm-12 form-group mb-3">
                                    ...
                                    <input type="email" name="email" id="email"
                                        ...
                                        value="{{ $beneficiarie->email }}" readonly>
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6  form-group mb-3">
                                    ...
                                    <input type="text" name="phone" id="phone"
                                        ...
                                        value="{{ $beneficiarie->phone }}"readonly required>
                                    @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" name="caste" id="caste"
                                            ...
                                            value="{{ $beneficiarie->caste }}"readonly required>
                                        @error('caste')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('identity_no') is-invalid @enderror"
                                        ...
                                        value="{{ old('identity_no') ?? ($beneficiarie->identity_no ?? '') }}" readonly
                                        required>
                            ...
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <input type="text" name="occupation" id="occupation"
                                    ...
                                    value="{{ $beneficiarie->occupation }}"readonly required>
                                @error('occupation')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 form-group mb-3" id="beneficiaryHelpDiv" style="display: none;">
                                ...
                                <textarea name="help_needed" id="beneficiary_help" rows="4"
                                    class="form-control @error('beneficiary_help') is-invalid @enderror"readonly required>{{ $beneficiarie->help_needed }}</textarea>
