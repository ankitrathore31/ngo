...
@section('content')
            ...
            <div class="col-auto">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Apporve Registraition</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-fluide m-3">
            <div class="card bg-white p-2 shadow rounded">
                <div class="text-black text-center border-bottom pb-3">
                    <h4 class=" p-3 bg-info rounded"><b>EDIT APPORVE FORM </b></h4>
                </div>
                <div class="card-body m-1">
                    <form method="POST" action="{{ route('update-apporve-registration', $record->id) }}"
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="upload-container">
                                        ...
                                        @if (!empty($record->image))
                                            <img id="previewImage"
                                                src="{{ asset('benefries_images/' . $record->image) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                @if (!empty($record->id_document))
                                    <img id="previewImage"
                                        src="{{ asset('benefries_images/' . $record->id_document) }}"
                            ...
                            <div class="col-md-6 form-group mb-3" id="beneficiaryHelpDiv" style="display: none;">
                                ...
                                <textarea name="help_needed" id="beneficiary_help" rows="4"
                                    class="form-control @error('beneficiary_help') is-invalid @enderror" required>{{ $record->help_needed }}</textarea>
                    ...
                    <div class="card bg-white p-2 shadow rounded m-2">
                        ...
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                <form action="{{ route('pending-status', ['type' => $record->reg_type, 'id' => $record->id] ) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                    @method('PATCH')
    ...
    <script>
        ...
        // Use old values if they exist, otherwise fallback to $record
